...
public:
     ...
     * @return 处理后的点云
     */
    [[nodiscard]] RawPointCloud::Ptr process(const RawPointCloud::ConstPtr &point_cloud);
...
private:
    ...
    float min_voxel_size_;           ///< 最小体素尺寸（m）
    float max_voxel_size_;           ///< 最大体素尺寸（m）
    size_t desire_point_cloud_size_; ///< 期望点云数量
};
